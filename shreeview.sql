...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jul 24, 2020 at 11:33 AM
...
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `godown_tc_view`;
CREATE TABLE IF NOT EXISTS `godown_tc_view` (
`trans_meta_id` int(11)
,`challan_no` varchar(32)
,`from_godown` int(5)
,`status` enum('new','old')
