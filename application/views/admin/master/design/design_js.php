<script defer="true" src="<?php echo base_url('optimum/admin') ?>/assets/libs/magnific-popup/dist/jquery.magnific-popup.min.js"></script>
<script defer="true" src="<?php echo base_url('optimum/admin') ?>/assets/libs/magnific-popup/meg.init.js"></script>
