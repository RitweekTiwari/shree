 <link href="<?php echo base_url('optimum/admin') ?>/assets/libs/magnific-popup/dist/magnific-popup.css" rel="preload" as="style" onload="this.rel = 'stylesheet'">
 <div id="content">
           ...
           <div class="modal-body">
             <div class="widget-content nopadding">
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-9">
                   <input type="text" class="form-control" name="designName" required value="" id="design_name">
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-sm-3">Design Series</label>
                 <div class="col-sm-9">
                   <input type="text" class="form-control" name="designSeries" required value="" id="designSeries">
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-sm-3">Fabric Name</label>
                 <div class="col-sm-9">
                   <select name="fabricName" id="fabricName" class="form-control" required>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-9">
                   <input type="number" class="form-control" name="stitch" value="" required>
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-sm-3">Dye</label>
                 <div class="col-sm-9">
                   <input type="text" class="form-control" name="dye" value="" required>
                 </div>
               </div>
               <div class="form-group row">
                 <label class="control-label col-sm-3">Matching</label>
                 <div class="col-sm-9">
                   <input type="text" class="form-control" name="matching" value="" required>
                 </div>
               </div>
 ...
 <div id="edit" class="modal hide">
   <div class="modal-dialog" role="document ">
     <div class="modal-content">
       <form class="form-horizontal" method="post" action="<?php echo base_url('admin/Design/edit/') ?>" enctype="multipart/form-data">
         <div class="modal-header">
         ...
         <div class="modal-body">
           <div class="widget-content nopadding">
             ...
             <div class="form-group row">
               <label class="control-label col-sm-3">Design Name</label>
               <div class="col-sm-9">
                 <input type="text" class="form-control" name="designName" id='designName1' required>
               </div>
             </div>
             <div class="form-group row">
               <label class="control-label col-sm-3">Design Series</label>
               <div class="col-sm-9">
                 <input type="text" class="form-control" name="designSeries" id='designSeries1' required>
               </div>
             </div>
             ...
             <div class="form-group row">
               <label class="control-label col-sm-3">Stitch</label>
               <div class="col-sm-9">
                 <input type="number" class="form-control" name="stitch" id='stitch1' required>
               </div>
             </div>
             <div class="form-group row">
               <label class="control-label col-sm-3">Dye</label>
               <div class="col-sm-9">
                 <input type="text" class="form-control" name="dye" id='dye1' required>
               </div>
             </div>
             <div class="form-group row">
               <label class="control-label col-sm-3">Matching</label>
               <div class="col-sm-9">
                 <input type="text" class="form-control" name="matching" id='matching1' required>
               </div>
             </div>
             ...
             <div class="form-group row">
               <label class="control-label col-sm-3">TH Catting Rate</label>
               <div class="col-sm-9">
                 <input type="number" class="form-control" name="htCattingRate" id='htCattingRate1' required>
               </div>
             </div>
