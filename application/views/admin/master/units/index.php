                                ...
                                <div class="modal-body">
                                  <div class="widget-content nopadding">
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <input type="text" class="form-control" name="unitName" required value="<?php echo $value->unitName; ?>">
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="control-label col-sm-3">Unit Symbol</label>
                                      <div class="col-sm-9">
                                        <input type="text" class="form-control" name="unitSymbol" required value="<?php echo $value->unitSymbol; ?>">
                                      </div>
                                    </div>
                                  </div>
                                </div>
        ...
        <div class="modal-body">
          <div class="widget-content nopadding">
            <div class="form-group row">
              <label class="control-label col-sm-3">Unit Name</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" name="unitName" value="" required>
              </div>
            </div>
            <div class="form-group row">
              <label class="control-label col-sm-3">Unit Symbol</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" name="unitSymbol" value="" required>
              </div>
            </div>
          </div>
        </div>
