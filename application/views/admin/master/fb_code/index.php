                  ...
                  <div class="modal-body">
                    <div class="widget-content nopadding">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="fbcode" value="<?php echo $value->fbcode; ?>" id="required">
                        </div>
                      </div>
                      </div>
                    </div>
    ...
    <div class="modal-body">
      <div class="widget-content nopadding">
        <div class="form-group row">
          ...
          <div class="col-sm-9">
            <input type="text" class="form-control" name="fbcode" value="" id="required">
          </div>
        </div>
        </div>
      </div>
