                    ...
                    if ($cust_data > 0) {
                      ...
                      foreach ($cust_data as $value) { ?>
                        <tr class="gradeU" id="tr_<?php echo $value->id ?>">
                          ...
                          <td><?php foreach ($grade_name as $rec) { ?>
                              <?php if ($value->grade == $rec->id) echo $rec->grade ?>
                            <?php } ?></td>
                                ...
                                <div class="modal-body">
                                  <div class="widget-content nopadding">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <input type="number" class="form-control" name="phone_no" required value="<?php echo $value->phone_no ?>">
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        ...
                                        <select name="grade" class="form-control" required>
                                          <?php foreach ($grade_name as $rec) : ?>
                                            <option <?php if ($value->grade == $rec->id) {
                                                    ?>selected<?php } ?> value="<?php echo $rec->id ?>"><?php echo $rec->grade ?></option>
                                          <?php endforeach; ?>
                                        </select>
                                      </div>
                                    </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <select name="grade" class="form-control">
                  <?php foreach ($grade_name as $rec) : ?>
                    <option value="<?php echo $rec->id; ?>"> <?php echo $rec->grade; ?> </option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
