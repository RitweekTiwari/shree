                        ...
                        <div id="<?php echo $value->id; ?>" class="modal hide">
                          <div class="modal-dialog" role="document ">
                            <div class="modal-content">
                              <form class="form-horizontal" method="post" action="<?php echo base_url('admin/Session_year/edit/') . $value->id ?>">
                                ...
                                <div class="modal-body">
                                  <div class="widget-content nopadding">
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-9">
                                        <input type="text" class="form-control" name="financial_year" required value="<?php echo $value->financial_year; ?>">
                                      </div>
                                    </div>
                                  </div>
                                </div>
...
<div id="addnew" class="modal hide">
  <div class="modal-dialog" role="document ">
    <div class="modal-content">
      <form class="form-horizontal" method="post" action="<?php echo base_url('admin/session_year/addSession') ?>">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="widget-content nopadding">
            <div class="form-group row">
              <label class="control-label col-sm-3">Financial Year</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" name="financial_year" value="" required>
              </div>
            </div>
          </div>
        </div>
