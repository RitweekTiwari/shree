                    ...
                    <tr>
                      <td class="align-top " style="width:700px;">
                        <table class="remove_datatable table-responsive" id="customer" style="height:500px; overflow-y: scroll;width:700px; overflow-x: scroll;">
                          ...
                          <tbody id="segment1-<?php echo $i ?>" class="segment1" row-id="<?php echo $i ?>" segment="<?php echo $value['segmentName'] ?>">
                            <tr id="segment1-tr-<?php echo $i ?>" class="segment1-tr" row-id="<?php echo $i ?>">
                              ...
                              <td style="width:15%"><input type="number" class="form-control length length<?php echo $i ?>" name="length[]" step="0.01" id="length<?php echo $i ?>" max="<?php echo $value['max'] ?>" min="<?php echo $value['min'] ?>" value="<?php echo $value['length'] ?>" data-value="<?php echo $value['length'] ?>"></td>
                              ...
                              <input type="hidden" id="min<?php echo $i ?>" value="<?php echo $value['min'] ?>"><input type="hidden" id="max<?php echo $i ?>" value="<?php echo $value['max'] ?>">
                              <td> <button type="button" value="1212" class="btn btn-success add_more">+</button></td>
                              <input type="hidden" name="segment[]" value="<?php echo $value['segmentName'] ?>">
                            </tr>
                          </tbody>
                          <tfoot>
                            <tr>
