<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#gradeFilter").on("submit", function(event) {
      event.preventDefault();
      var form = $(this).serialize();
      console.log(form);
      $.ajax({
        'url': "<?php echo base_url('/admin/Grade/filter'); ?>",
        'type': 'POST',
        'data': form,
        'success': function(response) {
          $('#grade').find('tbody').html(JSON.parse(response));
        }
      });
    });
    $("#fbcodeFilter").on("submit", function(event) {
      event.preventDefault();
      var form = $(this).serialize();
      console.log(form);
      $.ajax({
        'url': "<?php echo base_url('/admin/FbCode/filter'); ?>",
        'type': 'POST',
        'data': form,
        'success': function(response) {
          $('#fabric_code').find('tbody').html(JSON.parse(response));
        }
      });
    });
