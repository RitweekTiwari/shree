...
?>
  <tr id="tr_<?php echo $value['trans_meta_id'] ?>">
    ...
    <td><input type="text" class="form-control pbc" value="<?php echo $value['pbc'] ?>" readonly></td>
    ...
    <td><input type="text" class="form-control qty" name='cqty[]' value="<?php echo $value['quantity'] ?>" readonly></td>
